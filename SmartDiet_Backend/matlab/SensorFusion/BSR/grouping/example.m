...
imgFile = '/Users/vinoth/codebase/mobile_computing/SmartDiet_Backend/matlab/SensorFusion/BSR/grouping/data/101087.jpg';
outFile = '/Users/vinoth/codebase/mobile_computing/SmartDiet_Backend/matlab/SensorFusion/BSR/grouping/data/101087_gPb.mat';
...
imwrite(ucm,'/Users/vinoth/codebase/mobile_computing/SmartDiet_Backend/matlab/SensorFusion/BSR/grouping/data/101087_ucm.bmp');

% for regions 
ucm2 = contours2ucm(gPb_orient, 'doubleSize');
save('/Users/vinoth/codebase/mobile_computing/SmartDiet_Backend/matlab/SensorFusion/BSR/grouping/data/101087_ucm2.mat','ucm2');

%% 3. usage example
clear all;close all;clc;

%load double sized ucm
load('/Users/vinoth/codebase/mobile_computing/SmartDiet_Backend/matlab/SensorFusion/BSR/grouping/data/101087_ucm2.mat','ucm2');
...
figure;imshow('/Users/vinoth/codebase/mobile_computing/SmartDiet_Backend/matlab/SensorFusion/BSR/grouping/data/101087.jpg');
figure;imwrite(ucm, char('/Users/vinoth/codebase/mobile_computing/SmartDiet_Backend/matlab/SensorFusion/BSR/grouping/data/101087_seg.jpg'));
figure;imshow(bdry);
